            ...
            <div className="max-w-2xl mx-auto space-y-12">
                ...
                <div className="space-y-8 text-white/70 leading-relaxed">
                    <section>
                        ...
                        <p>
                            By accessing and using QR Buddy, you accept and agree to be bound by the terms and provision of this agreement.
                        </p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-white mb-4">5. Data Privacy & Storage</h2>
                        <p>
                            By using our service, you acknowledge that the QR code data you generate is stored securely in our encrypted database. We do not access, use, or share your private data. The storage is solely provided to enable history tracking and management features for your user account.
                        </p>
                    </section>
                </div>
            </div>
